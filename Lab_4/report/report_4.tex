...
\begin{document}
	...
	\hspace{1cm}Цель лабораторной работы - изучение двух реализаций алгоритма умножения матриц Винограда: последовательной и параллельной.
	...
	\begin{itemize}
		\item изучение алгоритм Винограда;
		\item изучение методoв параллельного программирования;
		\item применение знании программирования для реализации указанного алгоритма;
		\item выполнение сравнительного анализа последовательной реализации и параллельной реализации алгоритма Винограда при различном числе потоков;
		\item экспериментально подтверждение различии в эффективности по времени реализаций алгоритма Винограда.
	\end{itemize}
